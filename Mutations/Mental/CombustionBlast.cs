...
namespace XRL.World.Parts.Mutation
{
    ...
    public class CombustionBlast : BaseMutation
    {
        ...
        public void ActuallyFire(int Charges)
        {
            ...
            var line = PickLine(20, AllowVis.Any, null, false);
            ...
            {
                if (Head.Equipped != null && Head.Equipped.Blueprint != "Horns" && Head.Equipped.Blueprint != "Beak" && !Head.Equipped.HasStringProperty("InertObject") && !Head.Equipped.HasPart("NaturalEquipment"))
                {
            ...
            for (int index = 1; index < line.Count; index++)
            {
                ...
                GameObject obj = cell.FindObject(o => o.ConsiderSolidFor(ParentObject) || (o.HasPart("Combat") && !o.pPhysics.Solid));
            ...
            ParentObject.UseEnergy(EnergySpent);
        ...
        public override bool FireEvent(Event E)
        {
            ...
            if (E.ID == "AIGetOffensiveMutationList")
            {
                ...
                {
                    E.AddAICommand("CommandQuickFire");
        ...
        public override bool Mutate(GameObject GO, int Level)
        {
            ...
            this.CombustionBlastActivatedAbilityID = base.AddMyActivatedAbility(Name: "fire volley", Command: "CommandCombustionBlast", Class: "Mental Mutation", Description: "Fire a specified amount of psi-energy at target position.", Icon: "*");
            this.CombustionBlastVolleyActivatedAbilityID = base.AddMyActivatedAbility(Name: "quick fire", Command: "CommandQuickFire", Class: "Mental Mutation", Description: "Fire a single charge of psi-energy at target position.", Icon: "*");
