...
namespace XRL.World.Parts.Mutation
{
    ...
    public class Psybrachiomancy : BaseMutation
    {
        ...
        public Guid FormArmsAbilityID = Guid.Empty;
        ...
        public override bool HandleEvent(AttackerDealingDamageEvent E)
        {
            ...
            if (E.Actor == ParentObject && (GetEquippedPsionicLimb?.VariantType == "Psionic Hand") && E.Projectile == null)
            {
                ...
                E.Damage.Amount = (aDamage + EgoSum + Stat.Random(1, EgoSum)) / ArmCounter;
            }
        ...
        public override bool Mutate(GameObject GO, int Level)
        {
            ...
            this.FormArmsAbilityID = base.AddMyActivatedAbility(Name: "Dismiss Limb", Command: "CommandDismissLimb", Class: "Mental Mutation", Description: "Dismiss a psychic arm.\n\n", Icon: "<", Cooldown: 10);
        ...
        public override bool FireEvent(Event E)
        {
            if (E.ID == "CommandManifestLimb")
            {
                ...
                if (NewArmCost <= ParentObject.Statistics["PsiCharges"].BaseValue)
                {
                    ...
                    ArmCounter += 1;
                    int BaseCost = 5;
                    NewArmCost = (ArmCounter * (BaseCost + ArmCounter + ArmCost));
                    ArmCost += 5;
