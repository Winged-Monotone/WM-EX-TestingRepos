    ...
    public class Thermokinesis : BaseMutation
    {
        ...
        public void RemoveResistances()
        {
            ...
            else if (Target.HasEffect("Temperatura"))
            {
                ...
                XDidYToZ(ParentObject, "returns", null, Target, "resistances to normal", ".", null);
                return;
            }
        }
        ...
        public void ChangeTargetResistances(string ResistanceChoice, string ElementChoice)
        {
            ...
            {
                XDidYToZ(ParentObject, "alter", null, Target, "resistances to the elements", "!", null);
            }
        ...
        public override bool Mutate(GameObject GO, int Level)
        {
            ...
            this.ActivateThermokinesisAbilityID = base.AddMyActivatedAbility(Name: "Alter Temperatures", Command: "CommandAlterTemperatures", Class: "Mental Mutation", Description: "Raise or lower the resistance to fire or cold damage on a target or, raise or lower the ambient temperature of a radius at your target.", Icon: "*");
