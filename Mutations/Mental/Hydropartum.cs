...
namespace XRL.World.Parts.Mutation
{
    ...
    public class Hydropartum : BaseMutation
    {
        ...
        {
            this.FloodActivatedAbilityID = base.AddMyActivatedAbility(Name: "Torrent", Command: "TorrentBlastCommand", Class: "Mental Mutation", Description: "Unleash a torrent of water at your enemy as a cone-attack.", Icon: "*", Cooldown: 50);
        ...
        public static string[] ColorList = new string[5]
    {
        ...
        public void Hydrofabricate()
        {
            ...
            {
                base.PlayWorldSound("splashcast", 0.5f, 0, true, null);
                ...
                for (int index = 0; index < CellList.Count; index++)
                {
                    ...
                    if (C.ParentZone.IsActive() && C.IsVisible())
                    {
                        ...
                        {
                            if (Roll >= 90)
                                base.PlayWorldSound("flood1", 0.1f, 0, true, null);
                            else if (Roll >= 60)
                                base.PlayWorldSound("flood2", 0.1f, 0, true, null);
                            else if (Roll >= 30)
                                base.PlayWorldSound("flood3", 0.1f, 0, true, null);
                            else
                            {
