...
namespace XRL.World.Parts.Mutation
{
    ...
    public class Umbrameum : BaseMutation
    {
        ...
        {
            this.ShadowAreaEffectActivatedAbilityID = base.AddMyActivatedAbility(
             Name: "invoke darkness",
             Command: "CastShadowCommand",
             Class: "Mental Mutation",
             Description: "Invoke pure darkness over a radius at your targeted space.",
             Icon: "\u03A9");
            this.ShadeSelfActivatedAbilityID = base.AddMyActivatedAbility(
             Name: "shade self",
             Command: "ShadeSelfCommand",
             Class: "Mental Mutation",
             Description: "Invoke a constant shadow around yourself. Cannot be cancelled once activated.",
             Icon: "\u03A9");

            if (PlayerRepModified == false && ParentObject.IsPlayer())
            {
                XRL.Core.XRLCore.Core.Game.PlayerReputation.modify("seekers", -200, true);
        ...
        {
            return "An aura of darkness wafts about you, stealing light from the world. You hide your light--along with your glimmer.\n"
        ...
        public static string[] ColorList = new string[3]
{
        ...
        public void CastDarkness()
        {
            try
            {
                ...
                bool WorldMapcheck = !this.ParentObject.pPhysics.CurrentCell.ParentZone.IsWorldMap();
                    ...
                    if (WorldMapcheck)
                    {
                        ...
                        for (int index = 0; index < Cells.Count; index++)
                        {
                            ...
                            if (C.ParentZone.IsActive() && C.IsVisible())
                            {
                                ...
                                if (Roll <= 10)
                                {
                                    base.PlayWorldSound("darkness", 0.1f, 0, true, null);
                                }
            ...
            catch
            {
                ...
                AddPlayerMessage("Cannot be used while on Overmap.");
