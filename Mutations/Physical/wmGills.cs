...
namespace XRL.World.Parts.Mutation
{
    ...
    public class wmGills : BaseMutation
    {
        ...
        public override bool Mutate(GameObject GO, int Level)
        {
            ...
            {
                XRL.Core.XRLCore.Core.Game.PlayerReputation.modify("Fish", 100, true);
                XRL.Core.XRLCore.Core.Game.PlayerReputation.modify("Frogs", 100, true);
        ...
        public override void Register(GameObject ParentObject)
        {
            ...
            ParentObject.RegisterPartEvent((IPart)this, "MeleeAttackWithWeapon");
            ParentObject.RegisterPartEvent((IPart)this, "AttackerAfterMelee");
        ...
        public override bool FireEvent(Event E)
        {
            ...
            else if (E.ID == "DiveCommand")
            {
                ...
                // AddPlayerMessage("Testing Finished");
            }
            ...
            else if (E.ID == "PerformMeleeAttack")
            {
                ...
                if (Attacker == ParentObject && Attacker.HasEffect("wmSubmerged"))
                {
                    if (Patch_PhaseAndFlightMatches.TemporarilyDisabled == false)
                        Patch_PhaseAndFlightMatches.TemporarilyDisabled = true;
                }
            }
            else if (E.ID == "AttackerAfterMelee")
            {
                var Attacker = E.GetGameObjectParameter("Attacker");
                var Defender = E.GetGameObjectParameter("Defender");
                if (Attacker == ParentObject && Attacker.HasEffect("wmSubmerged"))
                {
                    if (Patch_PhaseAndFlightMatches.TemporarilyDisabled == true)
                    ...
                    if (Direction == null)
                    {
                        if (ParentObject != null)
                        {
                            ...
                            try
                            {
                                ...
                                XDidY(ParentObject, "rush", "from the depths to strike!", "!", "C");
                                Patch_PhaseAndFlightMatches.TemporarilyDisabled = false;
                            }
                            catch
                            {
