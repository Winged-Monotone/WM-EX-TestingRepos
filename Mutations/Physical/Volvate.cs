...
namespace XRL.World.Parts.Mutation
{
    ...
    {
        public Guid VolvationAbilityID;
        ...
        public override bool Mutate(GameObject GO, int Level)
        {
            ...
            VolvationAbilityID = activatedAbilities.AddAbility(Name: "Volvate", Command: "wmCommandVolvation", Class: "Physical Mutation", Description: "Volvate.", Icon: "O");
