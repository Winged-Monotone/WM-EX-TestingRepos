...
namespace XRL.World.Parts.Mutation
{
    ...
    public class Ovipositor : BaseDefaultEquipmentMutation
    {
            ...
            {
                {
                    ...
                    {
                        BirthEgg();
                        CooldownMyActivatedAbility(LayEggAbilityID, PlaceHolder, ParentObject);
                    }
                }
        ...
        public override bool Mutate(GameObject GO, int Level)
        {
            ...
            LayEggAbilityID = activatedAbilities.AddAbility(Name: "Lay Egg", Command: "CommandLayEgg", Class: "Physical Mutation", Description: "Lay an egg.", Icon: "O", Cooldown: PlaceHolder);
            ChangeLevel(Level);
