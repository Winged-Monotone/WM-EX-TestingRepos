...
namespace XRL.World.Parts.Mutation
{
    ...
    public class ChitinousSkin : BaseMutation
    {
        ...
        public int avBonus;
        public int STRBonus;
        public Guid MoltAbilityID = Guid.Empty;
            ...
            else if (E.ID == "EndTurn")
            {
                if (turnsTilMolt > 0)
                {
                    ...
                    if (turnsTilMolt <= 0)
                    {
                        ...
                        this.MoltAbilityID = activatedAbilities.AddAbility(Name: "Molt", Command: "CommandMolt", Class: "Physical Mutation", Description: "Molts your Husk.", Icon: "(Z)");
                    }
                }
        ...
        public override bool Mutate(GameObject go, int Level)
        {
            ...
            {
                XRL.Core.XRLCore.Core.Game.PlayerReputation.modify("Insects", 100, true);
                XRL.Core.XRLCore.Core.Game.PlayerReputation.modify("Crabs", 100, true);
                XRL.Core.XRLCore.Core.Game.PlayerReputation.modify("Arachnids", 100, true);
